...
public class Mole : MonoBehaviour
{
  ...
  [Header("WhackAMoleGameManager")]
  [SerializeField] private WhackAMoleGameManager gameManager;
  ...
  private void Awake()
  {
    ...
    if (gameManager == null)
      gameManager = FindObjectOfType<WhackAMoleGameManager>();

    if (gameManager == null)
      Debug.LogError("WhackAMoleGameManager not found in scene!");
  }
